...
<title>Ristorante da Pietro</title>
...
<h2 style="text-align:center;margin-top:50px;">Specialità del Giorno</h2>

<nav class="carosuel-container">
<div id="carousel" class="carousel slide">
<div class="carousel-inner">

<div class="carousel-item active">
<div>
<img src="/pietro/img/pasta.webp" class="d-block w-100" alt="Spagetti" type="image/webp">
</div>
<h3>Spagetti alla salsa di pomodoro</h3>
<div>
<ul>
<li>Spagetti 100g</li>
<li>Cipolla 10g</li>
<li>Salsa pomodoro 100g</li>
<li>Sale</li>
<li>Prezzemolo</li>
</ul>
</div>
...
<div>
<img src="/pietro/img/due.webp" class="d-block w-100" alt="Penne">
</div>
<h3>Penne alla salsa di pomodoro</h3>
<div>
<ul>
<li>Spagetti 100g</li>
<li>Cipolla 10g</li>
